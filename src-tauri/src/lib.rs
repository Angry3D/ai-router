...
use runtime::{
    ...
    mark_first_run_presented, move_route, open_codex_config, open_runtime_log_directory,
    ...
    refresh_all_balances, refresh_balance, restore_codex, restore_recovery_point,
    retry_database_startup, runtime_log_bootstrap_plugin, runtime_log_plugin, save_route,
    set_fallback_enabled, set_fallback_participant_count, show_settings_window,
...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            set_fallback_participant_count,
