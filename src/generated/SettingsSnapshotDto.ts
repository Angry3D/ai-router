...
export type SettingsSnapshotDto = { routes: Array<RouteSummaryDto>, activeRouteId: RouteId | null, fallback: FallbackStateDto, proxyPort: number, codexStatus: CodexConfigStatus, baseline: CodexBaselineSummaryDto, originalBackup: CodexBaselineSummaryDto, recoveryConfig: CodexRecoverySummaryDto, balanceScriptRiskConfirmed: boolean, balanceQuery: BalanceQuerySettingsDto, imagesGeneration: ImagesGenerationSettingsDto, history: HistorySummaryDto, metadataFailure: MetadataFailureDto, recovery: RecoveryHealthDto, menuBar: MenuBarSettingsDto, };
